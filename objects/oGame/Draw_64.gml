...
if (room == rCollection1)
{
	if (array_length(global.collection_array) == 121)
	{
		...
		draw_text(288,196,"Relaxing Dip")
		draw_text(512,196,"Steam Gekko")
		draw_text(704,196,"Mountain Birds")
...
if (room == rCollection2)
{
	if (array_length(global.collection_array) == 121)
	{
		...
		draw_text(96,196,"Field Min")
		draw_text(288,196,"Dew Min")
...
if (room == rCollection3)
{
	if (array_length(global.collection_array) == 121)
	{
		...
		draw_text(96,196,"Bush Lurker")
		draw_text(288,196,"Bumming Snail")
...
if (room == rCollection4)
{
	if (array_length(global.collection_array) == 121)
	{
		...
		draw_text(96,196,"Daygrazers")
		draw_text(288,196,"Geyser Sloth")
...
if (room == rCollection7)
{
	if (array_length(global.collection_array) == 121)
	{
		...
		draw_text(96,196,"Seasoned Traveler")
		draw_text(288,196,"Rain Hound")
